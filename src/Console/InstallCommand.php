...
class InstallCommand extends Command
{
    ...
    protected function createBuses()
    {
        ...
        $commandBusPath = "{$sharedPath}/Command/CommandBus.php";
        ...
        $commandInterfacePath = "{$sharedPath}/Command/Command.php";
        ...
        $queryBusPath = "{$sharedPath}/Query/QueryBus.php";
        ...
        $queryInterfacePath = "{$sharedPath}/Query/Query.php";
